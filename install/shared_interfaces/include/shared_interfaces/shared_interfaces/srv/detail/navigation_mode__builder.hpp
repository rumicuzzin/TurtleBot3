...
class Init_NavigationMode_Request_pose
{
public:
  explicit Init_NavigationMode_Request_pose(::shared_interfaces::srv::NavigationMode_Request & msg)
  : msg_(msg)
  {}
  ::shared_interfaces::srv::NavigationMode_Request pose(::shared_interfaces::srv::NavigationMode_Request::_pose_type arg)
  {
...
class Init_NavigationMode_Request_robot_mode
{
public:
  Init_NavigationMode_Request_robot_mode()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NavigationMode_Request_pose robot_mode(::shared_interfaces::srv::NavigationMode_Request::_robot_mode_type arg)
  {
    msg_.robot_mode = std::move(arg);
    return Init_NavigationMode_Request_pose(msg_);
  }
...
{
  return shared_interfaces::srv::builder::Init_NavigationMode_Request_robot_mode();
}

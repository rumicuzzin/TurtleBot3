  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x07, 0x3c, 0x30, 0xa2, 0x1f, 0x0b, 0xc1, 0x7f,
      0x22, 0xdd, 0x97, 0x03, 0xfa, 0x15, 0x68, 0xee,
      0x2b, 0x7f, 0x72, 0x62, 0xf7, 0x27, 0x8e, 0x82,
      0x89, 0xb6, 0x9e, 0x06, 0x5e, 0x5a, 0xb3, 0x44,
    }};
  return &hash;
}
...
static char shared_interfaces__msg__AddLog__TYPE_NAME[] = "shared_interfaces/msg/AddLog";
...
static char shared_interfaces__msg__AddLog__FIELD_NAME__task_type[] = "task_type";
static char shared_interfaces__msg__AddLog__FIELD_NAME__pose[] = "pose";
static char shared_interfaces__msg__AddLog__FIELD_NAME__complete[] = "complete";

static rosidl_runtime_c__type_description__Field shared_interfaces__msg__AddLog__FIELDS[] = {
  {
    {shared_interfaces__msg__AddLog__FIELD_NAME__task_type, 9, 9},
    {
  ...
  {
    {shared_interfaces__msg__AddLog__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {shared_interfaces__msg__AddLog__FIELD_NAME__complete, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription shared_interfaces__msg__AddLog__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {shared_interfaces__msg__AddLog__TYPE_NAME, 28, 28},
      {shared_interfaces__msg__AddLog__FIELDS, 3, 3},
    },
    {shared_interfaces__msg__AddLog__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *shared_interfaces__msg__AddLog__get_individual_type_description_source(NULL),

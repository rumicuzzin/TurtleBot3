...
#ifndef SHARED_INTERFACES__MSG__DETAIL__DEFECT_INFO__TYPE_SUPPORT_H_
#define SHARED_INTERFACES__MSG__DETAIL__DEFECT_INFO__TYPE_SUPPORT_H_
...
#endif  // SHARED_INTERFACES__MSG__DETAIL__DEFECT_INFO__TYPE_SUPPORT_H_

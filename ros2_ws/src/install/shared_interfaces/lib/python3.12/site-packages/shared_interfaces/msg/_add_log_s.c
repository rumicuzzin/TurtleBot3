...
bool shared_interfaces__msg__add_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shared_interfaces.msg._add_log.AddLog", full_classname_dest, 37) == 0);
  }
  shared_interfaces__msg__AddLog * ros_message = _ros_message;
  {  // task_type
...
{
  /* NOTE(esteve): Call constructor of AddLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shared_interfaces.msg._add_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddLog");

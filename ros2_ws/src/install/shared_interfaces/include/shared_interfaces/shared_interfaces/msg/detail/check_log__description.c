  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x6a, 0x3a, 0x42, 0x01, 0x22, 0x1c, 0xd2, 0xa2,
      0xd7, 0x6e, 0x42, 0x96, 0xe1, 0xb0, 0xc3, 0x73,
      0xc1, 0xe7, 0x67, 0x83, 0x48, 0x5c, 0x12, 0x11,
      0x12, 0xba, 0x09, 0x39, 0x0d, 0x7b, 0x8a, 0xbf,
    }};
  return &hash;
}
...
static char shared_interfaces__msg__CheckLog__TYPE_NAME[] = "shared_interfaces/msg/CheckLog";
...
static char shared_interfaces__msg__CheckLog__FIELD_NAME__task_type[] = "task_type";
static char shared_interfaces__msg__CheckLog__FIELD_NAME__index[] = "index";
static char shared_interfaces__msg__CheckLog__FIELD_NAME__pose[] = "pose";
static char shared_interfaces__msg__CheckLog__FIELD_NAME__complete[] = "complete";

static rosidl_runtime_c__type_description__Field shared_interfaces__msg__CheckLog__FIELDS[] = {
  {
    {shared_interfaces__msg__CheckLog__FIELD_NAME__task_type, 9, 9},
    {
  ...
  {
    {shared_interfaces__msg__CheckLog__FIELD_NAME__index, 5, 5},
    {
  ...
  {
    {shared_interfaces__msg__CheckLog__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {shared_interfaces__msg__CheckLog__FIELD_NAME__complete, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription shared_interfaces__msg__CheckLog__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {shared_interfaces__msg__CheckLog__TYPE_NAME, 30, 30},
      {shared_interfaces__msg__CheckLog__FIELDS, 4, 4},
    },
    {shared_interfaces__msg__CheckLog__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "# From logger node\n"
  "\n"
  "string task_type    # defect or delivery\n"
  "int8 index          # logger to index based on when they receive them\n"
  "geometry_msgs/PoseStamped pose\n"
  "bool complete       # visited/delivered";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *shared_interfaces__msg__CheckLog__get_individual_type_description_source(NULL),

...
static rosidl_typesupport_introspection_c__MessageMember shared_interfaces__srv__NavigationMode_Request__rosidl_typesupport_introspection_c__NavigationMode_Request_message_member_array[2] = {
  {
    ...
    offsetof(shared_interfaces__srv__NavigationMode_Request, nav_mode),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_interfaces__srv__NavigationMode_Request, target_pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer

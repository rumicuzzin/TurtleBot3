...
shared_interfaces__srv__RobotType_Request__init(shared_interfaces__srv__RobotType_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_type)) {
    shared_interfaces__srv__RobotType_Request__fini(msg);
    return false;
  }
  // index
  // pose
...
shared_interfaces__srv__RobotType_Request__create(void)
{
  ...
  shared_interfaces__srv__RobotType_Request * msg = (shared_interfaces__srv__RobotType_Request *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shared_interfaces__srv__RobotType_Request));
  bool success = shared_interfaces__srv__RobotType_Request__init(msg);
  if (!success) {
...
shared_interfaces__srv__RobotType_Request__Sequence__init(shared_interfaces__srv__RobotType_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Request * data = NULL;

  if (size) {
    data = (shared_interfaces__srv__RobotType_Request *)allocator.zero_allocate(size, sizeof(shared_interfaces__srv__RobotType_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shared_interfaces__srv__RobotType_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        shared_interfaces__srv__RobotType_Request__fini(&data[i - 1]);
      }
...
shared_interfaces__srv__RobotType_Request__Sequence__fini(shared_interfaces__srv__RobotType_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      shared_interfaces__srv__RobotType_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Request__Sequence * array = (shared_interfaces__srv__RobotType_Request__Sequence *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shared_interfaces__srv__RobotType_Request__Sequence__init(array, size);
  if (!success) {
...
shared_interfaces__srv__RobotType_Request__Sequence__destroy(shared_interfaces__srv__RobotType_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shared_interfaces__srv__RobotType_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shared_interfaces__srv__RobotType_Request__Sequence__are_equal(const shared_interfaces__srv__RobotType_Request__Sequence * lhs, const shared_interfaces__srv__RobotType_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shared_interfaces__srv__RobotType_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shared_interfaces__srv__RobotType_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shared_interfaces__srv__RobotType_Request * data =
      (shared_interfaces__srv__RobotType_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shared_interfaces__srv__RobotType_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shared_interfaces__srv__RobotType_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Response * msg = (shared_interfaces__srv__RobotType_Response *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shared_interfaces__srv__RobotType_Response));
  bool success = shared_interfaces__srv__RobotType_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
shared_interfaces__srv__RobotType_Response__destroy(shared_interfaces__srv__RobotType_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    shared_interfaces__srv__RobotType_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
shared_interfaces__srv__RobotType_Response__Sequence__init(shared_interfaces__srv__RobotType_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Response * data = NULL;

  if (size) {
    data = (shared_interfaces__srv__RobotType_Response *)allocator.zero_allocate(size, sizeof(shared_interfaces__srv__RobotType_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shared_interfaces__srv__RobotType_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        shared_interfaces__srv__RobotType_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
shared_interfaces__srv__RobotType_Response__Sequence__fini(shared_interfaces__srv__RobotType_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      shared_interfaces__srv__RobotType_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Response__Sequence * array = (shared_interfaces__srv__RobotType_Response__Sequence *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shared_interfaces__srv__RobotType_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
shared_interfaces__srv__RobotType_Response__Sequence__destroy(shared_interfaces__srv__RobotType_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shared_interfaces__srv__RobotType_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shared_interfaces__srv__RobotType_Response__Sequence__are_equal(const shared_interfaces__srv__RobotType_Response__Sequence * lhs, const shared_interfaces__srv__RobotType_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shared_interfaces__srv__RobotType_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shared_interfaces__srv__RobotType_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shared_interfaces__srv__RobotType_Response * data =
      (shared_interfaces__srv__RobotType_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shared_interfaces__srv__RobotType_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shared_interfaces__srv__RobotType_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
shared_interfaces__srv__RobotType_Event__init(shared_interfaces__srv__RobotType_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    shared_interfaces__srv__RobotType_Event__fini(msg);
    return false;
  }
  // request
  if (!shared_interfaces__srv__RobotType_Request__Sequence__init(&msg->request, 0)) {
    shared_interfaces__srv__RobotType_Event__fini(msg);
    return false;
  }
  // response
  if (!shared_interfaces__srv__RobotType_Response__Sequence__init(&msg->response, 0)) {
    shared_interfaces__srv__RobotType_Event__fini(msg);
    return false;
  }
  return true;
...
shared_interfaces__srv__RobotType_Event__fini(shared_interfaces__srv__RobotType_Event * msg)
{
  ...
  // request
  shared_interfaces__srv__RobotType_Request__Sequence__fini(&msg->request);
  // response
  shared_interfaces__srv__RobotType_Response__Sequence__fini(&msg->response);
}
...
shared_interfaces__srv__RobotType_Event__are_equal(const shared_interfaces__srv__RobotType_Event * lhs, const shared_interfaces__srv__RobotType_Event * rhs)
{
  ...
  // request
  if (!shared_interfaces__srv__RobotType_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!shared_interfaces__srv__RobotType_Response__Sequence__are_equal(
  ...
  shared_interfaces__srv__RobotType_Event * output)
{
  ...
  // request
  if (!shared_interfaces__srv__RobotType_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!shared_interfaces__srv__RobotType_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Event * msg = (shared_interfaces__srv__RobotType_Event *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(shared_interfaces__srv__RobotType_Event));
  bool success = shared_interfaces__srv__RobotType_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
shared_interfaces__srv__RobotType_Event__Sequence__init(shared_interfaces__srv__RobotType_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Event * data = NULL;

  if (size) {
    data = (shared_interfaces__srv__RobotType_Event *)allocator.zero_allocate(size, sizeof(shared_interfaces__srv__RobotType_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = shared_interfaces__srv__RobotType_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        shared_interfaces__srv__RobotType_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
shared_interfaces__srv__RobotType_Event__Sequence__fini(shared_interfaces__srv__RobotType_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      shared_interfaces__srv__RobotType_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  shared_interfaces__srv__RobotType_Event__Sequence * array = (shared_interfaces__srv__RobotType_Event__Sequence *)allocator.allocate(sizeof(shared_interfaces__srv__RobotType_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = shared_interfaces__srv__RobotType_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
shared_interfaces__srv__RobotType_Event__Sequence__destroy(shared_interfaces__srv__RobotType_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    shared_interfaces__srv__RobotType_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
shared_interfaces__srv__RobotType_Event__Sequence__are_equal(const shared_interfaces__srv__RobotType_Event__Sequence * lhs, const shared_interfaces__srv__RobotType_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  shared_interfaces__srv__RobotType_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(shared_interfaces__srv__RobotType_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    shared_interfaces__srv__RobotType_Event * data =
      (shared_interfaces__srv__RobotType_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!shared_interfaces__srv__RobotType_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          shared_interfaces__srv__RobotType_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!shared_interfaces__srv__RobotType_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }

...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavigationMode_Request_message_member_array[2] = {
  {
    ...
    offsetof(shared_interfaces::srv::NavigationMode_Request, nav_mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shared_interfaces::srv::NavigationMode_Request, target_pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer

...
bool shared_interfaces__msg__check_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shared_interfaces.msg._check_log.CheckLog", full_classname_dest, 41) == 0);
  }
  shared_interfaces__msg__CheckLog * ros_message = _ros_message;
  {  // task_type
...
{
  /* NOTE(esteve): Call constructor of CheckLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("shared_interfaces.msg._check_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CheckLog");
